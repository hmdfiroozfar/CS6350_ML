...
train_data = pd.read_csv('Data/train.csv', names = COLUMN_NAMES)
test_data = pd.read_csv('Data/test.csv', names = COLUMN_NAMES)
...
for bag in range(num_bags):
    bag_history = []
    sampled_indices = sample(range(len(train_features)), num_samples)
